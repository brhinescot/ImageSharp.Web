...
namespace SixLabors.ImageSharp.Web.Resolvers
{
    ...
    /// </summary>
    public class SpaPhysicalFileSystemResolver : IImageResolver
    {
        /// <summary>
        ...
        public SpaPhysicalFileSystemResolver(IHostingEnvironment environment, IBufferManager bufferManager, IOptions<ImageSharpMiddlewareOptions> options, IOptions<SpaStaticFilesOptions> spaOptions)
        {
        ...
        public async Task<IByteBuffer> ResolveImageAsync(HttpContext context, ILogger logger)
        {
            ...
            IFileInfo fileInfo = this.fileProvider.GetFileInfo(Path.Combine(this.spaOptions.RootPath, context.Request.Path.Value));
            IByteBuffer buffer;
